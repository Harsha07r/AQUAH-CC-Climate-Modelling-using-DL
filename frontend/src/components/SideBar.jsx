    ...
    <>
      ...
      `}>
        ...
        <div className="px-3 mb-6">
          ...
          <p className="text-xs text-gray-400 hidden sm:block">The Living Almanac, Jhelum Basin Guide</p>
        </div>
        ...
        <nav className="flex flex-col gap-1">
          ...
          <button className="w-full text-left flex items-center gap-3 px-3 py-2.5 rounded-xl text-gray-500 hover:bg-gray-50 hover:text-gray-800 text-sm transition-colors cursor-pointer">
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="mt-auto flex flex-col gap-3">
          ...
          <div className="border-t border-gray-100 pt-4 flex flex-col gap-1">
            ...
            <button className="w-full text-left flex items-center gap-3 px-3 py-2 text-sm text-gray-400 hover:text-gray-600 transition-colors cursor-pointer">
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
